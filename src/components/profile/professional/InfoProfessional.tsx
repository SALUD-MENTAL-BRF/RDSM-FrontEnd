                    ...
                    <div className="col-12 mt-5 container-info-professional">
                        ...
                        <div className="d-flex justify-content-end">
                          <div className="d-flex me-5">
                            <div role="button" className="text-center ms-4 me-4">
                              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="#10b981" className="bi bi-file-arrow-up" viewBox="0 0 16 16">
                            ...
                            <div role="button" className="text-center ms-3 me-3">
                                
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="#10b981" className="bi bi-heart-fill" viewBox="0 0 16 16">
                                ...
                                {   
                                    user?.roleId == 3 || user?.roleId == 1  && professional?.availability  ?
                                    <div role="button" className="d-flex row text-center mt-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="#10b981" className="bi bi-person-raised-hand" viewBox="0 0 16 16">
