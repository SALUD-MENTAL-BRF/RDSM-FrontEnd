...
import { ArrowLeft, Search, User, MoreHorizontal, UserCircle, BookOpen, MessageCircle, UserMinus,ChartNoAxesCombined  } from 'lucide-react';
                      ...
                      <AnimatePresence>
                        {activeDropdown === patient.id && patient.id !== undefined && (
                          ...
                          >
                            ...
                            <button className={styles.dropdownItem} onClick={() => navigate(`/meeting/${patient.id}/${professionalState?.id}`)}>
                              <MessageCircle size={16} />
                              Comunicarse
                            </button>
                            <button className={styles.dropdownItem} onClick={() => navigate(`/chat/professional/${patient.id}/${professionalState?.id}`)}>
                              <MessageCircle size={16} />
                              Chat
                            </button>
