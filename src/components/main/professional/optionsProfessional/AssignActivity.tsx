...
export const AssignActivity: React.FC<{professionalId: number}> = ({professionalId}) => {
    ...
    return(
        <div className="activitiesAssign-container mt-5 rounded-5">
            ...
            {
                    activitiesLinkedState?.map((data) => (
                        <div key={data.id} onClick={() => {}} className='d-flex justify-content-center mt-1 mb-1 col-12 col-sm-6 col-md-6 col-lg-4 col-xl-4 col-xxl-3'>
