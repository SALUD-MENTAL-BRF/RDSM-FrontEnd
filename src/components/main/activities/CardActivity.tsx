                                ...
                                <div onClick={() => 
                                    ...
                                    professional && unlinkActivity ? 
                                        <div className="text-end mt-1 me-2 d-flex">
                                            ...
                                            <div className="ms-1">
                                                <svg onClick={() => navigate(`/setting-activity/${professionalId}/${patientId}/${data.activityId}`)} xmlns="http://www.w3.org/2000/svg" width="31" height="31" fill="currentColor" className="bi bi-gear-fill" viewBox="0 0 16 16">
